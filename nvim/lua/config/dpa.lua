-- disable nvim-lsp inline diagnostic message
...
require("tiny-inline-diagnostic").setup({
	...
	hi = {
		...
		mixing_color = "#efefffff",   -- Can be None or a hexadecimal color (#RRGGBB). Used to blend the background color with the diagnostic background color with another color.
	},
	blend = {
		factor = 0.4,
	},
